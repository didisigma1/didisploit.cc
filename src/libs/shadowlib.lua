    ...
    function InsideLibrary:CreateTab(text)
        ...
        function InsideTab:CreateSlider(text, minvalue, maxvalue, callback)
            ...
            SliderButton.MouseButton1Down:Connect(function()
                ...
                pcall(function()
                    callback(Value)
                    TextLabel_2.Text = tostring(Value)
                end)
        ...
        function InsideTab:CreateButton(text, callback)
            ...
            Button_Roundify_3px.SliceScale = 0.020
        ...
        function InsideTab:CreateTextbox(text, callback)
            ...
            TextBox_2.Position = UDim2.new(1, 0, 0.333333343, 0)
            TextBox_2.Size = UDim2.new(0, 148, 0, 15)
            ...
            TextButton_Roundify_2px_3.Parent = TextBox_2
